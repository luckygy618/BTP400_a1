...
/**
 * The class called ViewAllLibrariansController allows an Admin user to display all Librarians in the database.
 * When the generate report button is pressed, it reads the data from database then displays the data on the
 * scrollable table view. A file with the data of the report is also generated and saved.
 * 
 * @author Tim Lai
 * @version 1.0
 * @since 1.0
