...
/**
 * The StudentRow class contains the data of the students table in the MySQL database. When the init()
 * method of the MyController class is called, this StudentRow object will be used to display data from
 * the table.
 * 
 * @author Tim Lai
 * @version 1.0
